...
-   Le logo et le mot "TerraCommuni" manuscrits ![](https://lh3.googleusercontent.com/8oC4RLtpeAv4X45zAv-KvXn82VMCWWfPlos1xOnJUAUlDO7jUKdivSvkJxREZZoKCvA6I548qkuQLLrU8aq20VC2aREsysFB6_QhfAxuCvzanJX08OD2skhJ7JO2qC7wDTQrTuKY8U9AZtBlcSMUIyQ)
...
Le lieu de la cérémonie doit être :

-   suffisamment grand pour que l'on puisse prendre en photo le groupe complet de participants afin de les compter sur la photographie (cf. critère 6, avec tous les participants) ;

-   en extérieur afin que l'arrière-plan montre des repères que l'on puisse facilement reconnaître par vue satellite (cf. critère 5, un arrière-plan reconnaissable par satellite) ;

-   avec un grand objet bien vertical comme un poteau, un mât d'antenne ou de drapeau afin que l'on puisse bien voir sur le sol la direction de l'ombre de cet objet (cf. critère 18, l'ombre au sol d'un objet vertical et critère 19, un azimut repérable par satellite) ;
...
-   où on a de fortes chances d'avoir du soleil et de voir clairement l'ombre du grand objet vertical sur le sol (cf. critère 18, l'ombre au sol d'un objet vertical) ;
...
-   informer les participants de l'organisation d'une cérémonie TerraCommuni ;

-   motiver les participants, leur expliquer pourquoi ils devraient contribuer au projet ;
...
-   la feuille de la cérémonie (cf. critère 17, la feuille de cérémonie) ;

-   un fil suspendu entre son pouce et son index (cf. critère 20, un fil suspendu) ;

-   la feuille et le fil de manière telle qu'on verra l'ombre de son index sur la feuille (cf. critère 21, l'ombre du pouce et de l'index) ;
...
-   Le logo et le mot "TerraCommuni" ![](https://lh3.googleusercontent.com/8oC4RLtpeAv4X45zAv-KvXn82VMCWWfPlos1xOnJUAUlDO7jUKdivSvkJxREZZoKCvA6I548qkuQLLrU8aq20VC2aREsysFB6_QhfAxuCvzanJX08OD2skhJ7JO2qC7wDTQrTuKY8U9AZtBlcSMUIyQ)

-   L'identifiant de l'organisateur (son numéro de téléphone ou adresse email) pour qu'il puisse être compté ;
...
-   distribuer une feuille blanche et un feutre noir épais (pas un stylo fin ni un crayon) pour chaque participant ayant un numéro de téléphone ou une adresse email ;

-   demander à chacun d'inscrire en gros et de manière très lisible "TerraCommuni" en haut de la feuille de papier (cf. critère 10, le mot TerraCommuni sur chaque papier) ;

-   demander à chacun d'inscrire en gros et de manière très lisible son numéro de téléphone ou son adresse email sur sa feuille (cf. critère 9, des identifiants et critère 11, un papier par identifiant) ;

-   demander à chacun d'inscrire aussi le nombre de participants qui sont représentés par ce numéro de téléphone ou cette adresse email (un participant n'a pas le droit d'être représenté par plusieurs numéros de téléphone ou adresses email de la cérémonie) ; par exemple, si une maman est venue avec ces 5 enfants, alors elle inscrit "6 personnes" sous son numéro de téléphone et aucune autre maman ne peut compter ces 5 enfants-là (cf. critère 12, des identifiants partageables, critère 13, plusieurs participants par identifiant et critère 14, un seul participant par identifiant).

Quand toutes les feuilles sont remplies, il faut encore :

-   vérifier que chaque participant est bien compté une et une seule fois sur les feuilles (personne n'est compté deux fois et tout le monde est bien compté, cf. critère 15, un décompte exact) ; corriger si nécessaire ;
...
-   on va d'abord filmer le groupe complet qui répondra aux questions de l'organisateur ;

-   puis on prendra 3 photos du groupe complet ;

-   puis on va se rapprocher pour filmer  chaque petit groupe de participants avec sa feuille vue de près ;
...
-   commencer par filmer l'objet vertical,

-   Puis se tourner vers son ombre au sol,

-   Puis se tourner vers le repère vers lequel elle pointe,
...
-   voir différents repères d'arrière-plan (cf. critère 5, un arrière-plan reconnaissable par satellite),

-   pouvoir compter tous les participants (cf. critère 6, avec tous les participants et critère 15, un décompte exact),
...
[![](https://lh6.googleusercontent.com/VueReUDpfNx-uOafIGo6fVDCzrPQ-3TlrkF2S66gJvZ2snxdf4pQkKCj4A7n16SO-uw5BkGdQkFseukgRsYPfHawORZQTGER1vC1yykCkh6S2-tfIK3zKScQ9zF0tuxGzYYLlsb6zuH26B-shoIqbgQ)](https://drive.google.com/file/d/1VCfZ7_Rfj7j8R5-AgZUqNIPPlVOukej8/view?usp=sharing)

![](https://lh4.googleusercontent.com/qpUTZMJOMbMqt4sOn6YKBDfbJCmJtQ7psMCtvdPxswW9lHH1hByV5_Gnn-vP-8TJxCwBm4c1bEEWSXv5Qqzy2FYsNmVUfI3XCasJZdEQOoJmWWAf44_xklVYRtRWZ_lBVbSolDTXdtx7HzjIzu5FoF8)
...
![](https://lh5.googleusercontent.com/s2OEwxWncxB5yTY0WoecNM_0-gWfgtXP5oEkm8CIAvBCEc_DJMbMP-7-H3Wj6jouimSYK9TtGo3X_gRYmvgMZ_IGqy4l5o-DvxyPw6L4DHsIaLqj6kdrkSGvlO4GW1AFb7fwNZKBr2H7RZSngZMQBmI)![](https://lh3.googleusercontent.com/bb4f-lxNLaoM-ByGC1IasYYn00YBJpUiQXKLQZGL5u8Ye9fSvNVPFYQuE2cS23HI1kmxYQZxMUa8mvwfRZNNmVkRQoMMwc58pRdCYMNcBt-QugC6AsVYGWwD63Paip3iYq1m5rLAR1RbxvhZ149RxHQ)
...
![](https://lh5.googleusercontent.com/KGFFgUyVJGmSCk4UVToEsAwBqE3syaNr7eA8IzG9N-zWHYjPiLs-nk2puDU2Pz69OkdHsXTNCTRVm0E0Xlb2cbiG5-RmTuuWrmwUyqNOwyUpYTIoXp8G8cqVsQHzGbvEkqjEnq0Dir8zxOXJs7YOlbg)
...
![](https://lh6.googleusercontent.com/1zPDfPx0PLOe8WZZkF-j2HLZZELzVdCltHO-ljGeyWm6Aae4IGJBSjNiF2B8sTzHlf_vi4ZVR5E-3JErTZxRTrt4Q-fakC5HQxJlDz6ydlAV0_cCV6gz4YUHhEFFoAXV_yMZ8X6UJrni52eeuAcpjQs)![](https://lh6.googleusercontent.com/HXrdBwfuS5z29Cw1HBXzwgGLOm9PzhlOGGzpvyCva41Z-pSGzQYBhWzfjPYGSvJQ5CNgd5-SOPerqnuQB6ZldgJ6ghWTJRVcMwBJqDbKbB8lo2ttMVgr79jZVQnjuWxXWUBEXLhpod48raNwZTd9qtk)
...
